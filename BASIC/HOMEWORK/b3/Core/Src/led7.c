...
///////////////////////////////////////
void LED7B_WriteByte(uint8_t c);

void LED7B_WriteByte(uint8_t c)
{
  if (((c >> 0) & 0x01) == 1) { A2_SET(); } else { A2_RESET(); }
  if (((c >> 1) & 0x01) == 1) { B2_SET(); } else { B2_RESET(); }
  if (((c >> 2) & 0x01) == 1) { C2_SET(); } else { C2_RESET(); }
  if (((c >> 3) & 0x01) == 1) { D2_SET(); } else { D2_RESET(); }
  if (((c >> 4) & 0x01) == 1) { E2_SET(); } else { E2_RESET(); }
  if (((c >> 5) & 0x01) == 1) { F2_SET(); } else { F2_RESET(); }
  if (((c >> 6) & 0x01) == 1) { G2_SET(); } else { G2_RESET(); }
  if (((c >> 7) & 0x01) == 1) { DP2_SET(); } else { DP1_RESET(); }
}
