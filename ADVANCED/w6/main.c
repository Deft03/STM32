...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
		...
		//Input
		if ((state==0)&&(HAL_GPIO_ReadPin(GPIOD,GPIO_PIN_11)==0))
		{
			state=1;
			D1_state=1;
		}
		if ((state==1)&&(HAL_GPIO_ReadPin(GPIOD,GPIO_PIN_11)==1))
		{
			state=2;
			D1_state=1;
		}
		if ((state==2)&&(HAL_GPIO_ReadPin(GPIOD,GPIO_PIN_11)==0))
		{
			state=3;
			D1_state=0;
		}
		if ((state==3)&&(HAL_GPIO_ReadPin(GPIOD,GPIO_PIN_11)==1))
		{
			state=4;
			D1_state=0;
		}
		if ((state==4)&&(HAL_GPIO_ReadPin(GPIOD,GPIO_PIN_11)==0))
		{
			state=1;
			D1_state=1;
		}
		...
		if (state==0)
		{
			HAL_GPIO_WritePin(GPIOA,GPIO_PIN_7,D1_state);
